...
import { IconComponent } from 'src/app/shared/ui-modules/icon/app-icon.component';
import {IconService} from "src/app/shared/ui-modules/icon/services/app-icon.service";
